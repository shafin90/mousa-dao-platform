...
const StationEditPage: React.FC = () => {
    ...
    stationApi.getById(id)
      .then((station: StationData) => {
        ...
        setForm({
          ...
          lat: station.location?.lat != null ? String(station.location.lat) : "",
          lng: station.location?.lng != null ? String(station.location.lng) : "",
          isActive: station.isActive !== false,
          manager1: idOf(station.manager1),
          manager2: idOf(station.manager2),
        });
      })
      .catch(() => showError(t("stations.notFound")))
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div className="space-y-1">
          <Button variant="ghost" size="sm" className="-ml-2 gap-2" onClick={() => navigate(`/stations/${id}`)}>
      ...
      <form onSubmit={handleSave}>
        ...
        <div className="mt-6 flex justify-end gap-2">
          <Button type="button" variant="outline" className="gap-2" onClick={() => navigate(`/stations/${id}`)}>

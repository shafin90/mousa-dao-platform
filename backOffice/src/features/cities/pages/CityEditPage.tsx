    ...
    cityApi.getById(id)
      .then((city) => {
        ...
        setForm({
          ...
          email1: city.email1 || "",
          email2: city.email2 || "",
          manager1: idOf(city.manager1),
          manager2: idOf(city.manager2),
          lat: city.location?.lat != null ? String(city.location.lat) : "",
          lng: city.location?.lng != null ? String(city.location.lng) : "",
          isActive: city.isActive !== false,
        });
      })
      .catch(() => showError(t("cities.notFound")))
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div className="space-y-1">
          <Button variant="ghost" size="sm" className="-ml-2 gap-2" onClick={() => navigate(`/cities/${id}`)}>
      ...
      <form onSubmit={handleSave}>
        ...
        <div className="mt-6 flex justify-end gap-2">
          <Button type="button" variant="outline" className="gap-2" onClick={() => navigate(`/cities/${id}`)}>

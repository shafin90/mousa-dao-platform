...
const StationEditPage = lazy(() => import("@/features/stations/pages/StationEditPage"));
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        element: <SuspenseWrapper><StationEditPage /></SuspenseWrapper>,
      },
      {
        path: "stations/:id",
      ...
      {
        path: "cities/:id/edit",
        element: <SuspenseWrapper><CityEditPage /></SuspenseWrapper>,
      },
      {
        path: "cities/:id",

...
const createBusSchema = Joi.object({
  ...
  seatRows: Joi.number().integer().min(1).allow(null).optional(),
  seatsPerRow: Joi.number().integer().min(1).max(10).allow(null).optional(),
  leftSeats: Joi.number().integer().min(0).max(10).allow(null).optional(),
  rightSeats: Joi.number().integer().min(0).max(10).allow(null).optional(),
